...
public protocol SequenexOpenIdConnectLibraryProtocol {
    var isAuthenticated: Bool { get }
    var isAuthorized: Bool { get }
    var onStateChanged: (() -> Void)?{ get }
    func authWithAutoCodeExchange(parent: UIViewController)
    func authWithNoCodeExchange(parent: UIViewController)
    var isCodeExchangePossible: Bool { get }
    func codeExchange()
    func clearAuthState()
    func onApplication(_ app: UIApplication, open url: URL,
                       options: [UIApplication.OpenURLOptionsKey: Any]) -> Bool
}

public class SequenexOpenIdConnectLibrary: NSObject,
    OIDAuthStateChangeDelegate, OIDAuthStateErrorDelegate, SequenexOpenIdConnectLibraryProtocol {
    let issuer: String, clientID: String?, redirectURI: String
    private var authState: OIDAuthState?
    public var onStateChanged: (() -> Void)?
    var currentAuthorizationFlow: OIDExternalUserAgentSession?

    public var isAuthenticated: Bool { authState != nil }
