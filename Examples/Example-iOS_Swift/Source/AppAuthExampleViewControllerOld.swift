...
class AppAuthExampleViewControllerOld: UIViewController {
    ...
    private let appDelegate = UIApplication.shared.delegate as? AppDelegateOld
...
extension AppAuthExampleViewControllerOld {
